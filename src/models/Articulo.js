...
class Articulo {
  ...
  calcularPrecioFinal(ivaGlobal = 21) {
    const ivaGlobalNormalizado = Number(ivaGlobal);
    const ivaGlobalSeguro = Number.isFinite(ivaGlobalNormalizado) ? ivaGlobalNormalizado : 21;
    const ivaAplicar = this.protegido ? this.iva : ivaGlobalSeguro;

...
class ScannerController {
  ...
  renderizar() {
    ...
    const imgArticulo = document.getElementById('imgArticulo');
    if (imgArticulo) {
      if (this.articulo.imagen) {
        imgArticulo.src = this.articulo.imagen;
        imgArticulo.style.display = 'block';
      } else {
        imgArticulo.style.display = 'none';
      }
    }
